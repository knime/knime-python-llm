...
class LMMAgentTypeSettings:
    ...
    agent_type = knext.EnumParameter(
        "Agent Type",
...
class MemoryTypeSettings:
    ...
    memory_type = knext.EnumParameter(
        "Memory Type",
...
class AgentPortObject(knext.PortObject):
    ...
    @classmethod
    def deserialize(cls, spec: AgentPortObjectSpec, data: bytes):
...
class LLMAgentCreator:
    ...
    agent_type = LMMAgentTypeSettings()
    ...
    def configure(
        ...
        return AgentPortObjectSpec(self.agent_type, self.memory_type)
    ...
    def execute(
        ...
        return AgentPortObject(
            AgentPortObjectSpec(self.agent_type, self.memory_type), lmm, tool_list
        )
