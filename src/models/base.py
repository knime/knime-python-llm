...
import models.structured_output as so
...
class OutputFormatOptions(knext.EnumParameterOptions):
    ...
    JSON = (
        ...
        that parse into a valid JSON object. Make sure you include the string "JSON"
...
class LLMPrompter:
    ...
    **Note**: If you use the
    ...
    structured_output_settings = so.StructuredOutputSettings(
    ...
    def configure(
        ...
        # Validate that the selected output format is supported by the model
    ...
    def execute(
        ...
        llm: BaseChatModel = _initialize_model(llm_port, ctx, self.output_format)
