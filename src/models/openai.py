...
class GPTImage1Settings:
    ...
    background = knext.StringParameter(
        label="Background",
    ...
    moderation = knext.StringParameter(
        label="Moderation",
    ...
    **Note**: If you use the
    ...
    def _create_with_gpt_image_1(self, client) -> bytes:
        ...
        response = client.images.generate(
            ...
            model=self.model,
            n=1,
            quality=self.gpt_image_1_settings.quality,
            size=self.gpt_image_1_settings.size,
            style=self.gpt_image_1_settings.style,
        )
