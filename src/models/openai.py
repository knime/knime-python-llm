...
@knext.parameter_group(label="GPT Image 1 Settings", since_version="5.5.0")
class GPTImage1Settings:
    class ImageSizeOptions(knext.EnumParameterOptions):
        SIZE_1024x1024 = ("1024x1024", "Default")
    ...
    size = knext.EnumParameter(
        ...
        default_value=ImageSizeOptions.SIZE_1024x1024.name,
        style=knext.EnumParameter.Style.VALUE_SWITCH,
    )
    ...
    class BackgroundOptions(knext.EnumParameterOptions):
        ...
        AUTO = ("Auto", "Automatically determined background")
    ...
    class ModerationOptions(knext.EnumParameterOptions):
        AUTO = ("Auto", "Automatic moderation")
        LOW = ("Low", "Low moderation level")

    moderation = knext.EnumParameter(
        label="Moderation",
        description="Allows to set the content moderation level for the generated image.",
...
class ImageModels(knext.EnumParameterOptions):
    GPT_IMAGE_1 = ("GPT Image 1", "State-of-the-art image generation model.")
    DALL_E_3 = ("DALL-E 3", "Previous generation image generation model")
...
class OpenAIDALLEView:
    ...
    **Note**: The use of GPT Image 1 may require your organization to be verified by OpenAI.
    ...
    **Note**: If you use the
    ...
    model = knext.EnumParameter(
        ...
        since_version="5.5.0",
        description="The model to use for image generation. GPT image 1 is the recommended model.",
        style=knext.EnumParameter.Style.VALUE_SWITCH,
    )
    ...
    settings = ImagelLoaderInputSettings().rule(
    ...
    def _create_with_gpt_image_1(self, client) -> bytes:
        ...
        size = GPTImage1Settings.ImageSizeOptions[self.gpt_image_1_settings.size].label
