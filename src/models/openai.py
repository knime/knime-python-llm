...
class GPTImage1Settings:
    ...
    class ModerationOptions(knext.EnumParameterOptions):
        Auto = ("Auto", "Basic filtering that tries to block certain "
...
class OpenAIDALLEView:
    """
    Generate images with OpenAI's DALL-E 3 or GPT Image 1.
    ...
    **Note**: If you use the
    ...
    def _create_with_gpt_image_1(self, client) -> bytes:
        ...
        size = GPTImage1Settings.ImageSizeOptions.size_to_dimension(self.gpt_image_1_settings.size)
        ...
        try:
            ...
            error_message = str(e)
            if "Error code: 400" in error_message and "moderation_blocked" in error_message:
                raise RuntimeError(
